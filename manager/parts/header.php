...
<nav class="navbar navbar-expand-lg navbar-light bg-light">
  <div class="container-fluid">
    <a class="navbar-brand" onclick="goToPage('home')">STLSHDWS Manager</a>
      ...
      <li class="nav-item">
          <a class="nav-link" aria-current="page" onclick="goToPage('roles')">User roles</a>
      </li>
      <li class="nav-item">
          <a class="nav-link" aria-current="page" onclick="goToPage('roulette')">roulette</a>
      </li>
